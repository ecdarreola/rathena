...
void initChangeTables(void)
{
	...
	set_sc( SO_STRIKING		, SC_STRIKING		, EFST_STRIKING		, SCB_WATK );
	...
	StatusChangeFlagTable[SC_CLOUD_POISON] |= EFST_CLOUD_POISON;
	...
	StatusChangeFlagTable[SC_CLOUD_POISON] |= SCB_NONE;
